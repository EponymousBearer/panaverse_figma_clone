...
const Boxes: FC<Iprops> = ({
  ...
  return (
    <div className="flex flex-col md:gap-y-5 rounded-md pb-24 p-10 flex-1 relative border-2">
      <h2 className="text-base 3xl:text-2xl font-semibold">{header}</h2>
      <p className="text-lg 3xl:text-2xl text-slate-600">{description}</p>
    ...
    //   <p className="text-slate-600 3xl:mt-1 23xl:text-[28px] 3xl:leading-[34px] laptop:text-lg laptop:mt-2 tab:text-sm mobile:text-[13px]">{description}</p>
