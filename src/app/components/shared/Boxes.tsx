  ...
  return (
    <div>
      <div className={`mx-auto mobile:px-2 mobile:py-10 tab:px-2 tab:py-10 laptop:px-8 laptop:py-14 3xl:px-12 3xl:py-20 relative  ${haveBorder && "border-4"}`}>
        <h1 className="font-semibold laptop:text-2xl 3xl:text-[34px]">{header}</h1>
        <p className="text-slate-600 3xl:mt-1 3xl:text-[28px] 3xl:leading-[34px] laptop:text-lg laptop:mt-2 tab:text-sm mobile:text-[10px]">{description}</p>
